# -*- coding: utf-8 -*-
#
# rocon documentation build configuration file, created by
...
latex_documents = [
  ('index', 'rocon.tex', u'rocon Documentation',
...
man_pages = [
    ('index', 'rocon', u'rocon Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'rocon', u'rocon Documentation',
   u'Daniel Stonier', 'rocon', 'One line description of project.',
   'Miscellaneous'),
]
